...
func (AdminResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_admin_proto_rawDescGZIP(), []int{8, 0}
}
...
var file_admin_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x32, 0xcc, 0x04, 0x0a, 0x0c, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x53, 0x65, 0x72, 0x76,
...
var file_admin_proto_goTypes = []interface{}{
	...
	(*AdminProductList)(nil),  // 2: pb.AdminProductList
	(*AdminProduct)(nil),      // 3: pb.AdminProduct
	(*AdminNoParam)(nil),      // 4: pb.AdminNoParam
	(*AdID)(nil),              // 5: pb.AdID
	(*AdminCategoryList)(nil), // 6: pb.AdminCategoryList
	(*AdminCategory)(nil),     // 7: pb.AdminCategory
	(*AdminLogin)(nil),        // 8: pb.AdminLogin
	(*AdminResponse)(nil),     // 9: pb.AdminResponse
}
var file_admin_proto_depIdxs = []int32{
	3,  // 0: pb.AdminProductList.Products:type_name -> pb.AdminProduct
	7,  // 1: pb.AdminProduct.Category:type_name -> pb.AdminCategory
	7,  // 2: pb.AdminCategoryList.Categories:type_name -> pb.AdminCategory
	0,  // 3: pb.AdminResponse.status:type_name -> pb.AdminResponse.Status
	8,  // 4: pb.AdminService.AdminLoginRequest:input_type -> pb.AdminLogin
	1,  // 5: pb.AdminService.AddToAdminWallet:input_type -> pb.Amount
	7,  // 6: pb.AdminService.AddCategory:input_type -> pb.AdminCategory
	5,  // 7: pb.AdminService.FindCategory:input_type -> pb.AdID
	4,  // 8: pb.AdminService.FindCategories:input_type -> pb.AdminNoParam
	7,  // 9: pb.AdminService.EditCategoryAdmin:input_type -> pb.AdminCategory
	5,  // 10: pb.AdminService.RemoveCategoryAdmin:input_type -> pb.AdID
	5,  // 11: pb.AdminService.FindProductByID:input_type -> pb.AdID
	4,  // 12: pb.AdminService.FindAllProducts:input_type -> pb.AdminNoParam
	5,  // 13: pb.AdminService.RemoveProduct:input_type -> pb.AdID
	5,  // 14: pb.AdminService.AdminBlockUser:input_type -> pb.AdID
	9,  // 15: pb.AdminService.AdminLoginRequest:output_type -> pb.AdminResponse
	9,  // 16: pb.AdminService.AddToAdminWallet:output_type -> pb.AdminResponse
	9,  // 17: pb.AdminService.AddCategory:output_type -> pb.AdminResponse
	7,  // 18: pb.AdminService.FindCategory:output_type -> pb.AdminCategory
	6,  // 19: pb.AdminService.FindCategories:output_type -> pb.AdminCategoryList
	7,  // 20: pb.AdminService.EditCategoryAdmin:output_type -> pb.AdminCategory
	9,  // 21: pb.AdminService.RemoveCategoryAdmin:output_type -> pb.AdminResponse
	3,  // 22: pb.AdminService.FindProductByID:output_type -> pb.AdminProduct
	2,  // 23: pb.AdminService.FindAllProducts:output_type -> pb.AdminProductList
	9,  // 24: pb.AdminService.RemoveProduct:output_type -> pb.AdminResponse
	9,  // 25: pb.AdminService.AdminBlockUser:output_type -> pb.AdminResponse
